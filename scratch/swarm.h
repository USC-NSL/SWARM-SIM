...
const char edgeLanAddressMask[] = "255.255.255.0";
...
/**
 * We support 3 types of routing:
 *  - GOD_SP   : Global routing without multipath (i.e. just use Ipv4GlobalRouting)
 *  - GOD_ECMP : Randomly spit packets on equal length paths. Not good with TCP
 *  - WCMP     : Do WCMP over a series of static routes
*/
typedef enum routing_type_t {
    GOD_SP, GOD_ECMP, WCMP
} routing_type;
...
#define WCMP_LIST_ROUTING_PRIORITY -20

...
template_no_action="mpiexec -np 40 %s \
    --mpi --podLps=32 --coreLps=8 --offloadAgg --offloadCore \ 
...
template_disable_high="mpiexec -np 40 %s \
    --mpi --podLps=32 --coreLps=8 --offloadAgg --offloadCore \ 
    --numPods=8 --switchRadix=8 --numServers=4 --linkRate=20Gbps --linkDelay=100us \
    --end=10.0 \
    --monitor --noAcks --until=1.0 \
...
template_disable_low="mpiexec -np 40 %s \
    --mpi --podLps=32 --coreLps=8 --offloadAgg --offloadCore \ 
    --numPods=8 --switchRadix=8 --numServers=4 --linkRate=20Gbps --linkDelay=100us \
    --end=10.0 \
    --monitor --noAcks --until=1.0 \
...
template_disable_both="mpiexec -np 40 %s \
    --mpi --podLps=32 --coreLps=8 --offloadAgg --offloadCore \ 
    --numPods=8 --switchRadix=8 --numServers=4 --linkRate=20Gbps --linkDelay=100us \
    --end=10.0 \
    --monitor --noAcks --until=1.0 \
    --flow=traffic-hadoop$1.txt --out=fct-disable-both-$1 --scenario=scenario-disable-both.txt"
